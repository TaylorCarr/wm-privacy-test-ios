...
install_xcframework "${PODS_ROOT}/AppLovinSDK/applovin-ios-sdk-10.3.6/AppLovinSDK.xcframework" "AppLovinSDK" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
